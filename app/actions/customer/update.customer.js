module.exports = ({ customerRepository, Customer, customerValidator }) =>
  async (id, updatedCustomer) => {
    ...
    if (!updateResult) throw new Error(`Could not find customer with id ${id}`);
